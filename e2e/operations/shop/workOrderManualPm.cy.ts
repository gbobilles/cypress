...
TestFilters(['e2e', 'workOrderManualPm'], () => {
  describe('E2E workflow - Manually Generated PM Work Request / Internal Work Order', () => {
    ...
    it('checks the E2E workflow - Manually Generated PM Work Request / Internal Work Order', { tags: 'e2e-wo-manual-pm' }, () => {
